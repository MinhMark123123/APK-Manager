...
public abstract class AbstractGetNameTask  extends AsyncTask<Void, Void, Void>{
    ...
    private LoginTaskControl mLoginTaskControl;

    AbstractGetNameTask(HomeActivity activity, String email, String scope, LoginTaskControl mLoginTaskControl) {
        this.mActivity = activity;
        this.mScope = scope;
        this.mEmail = email;
        this.mLoginTaskControl = mLoginTaskControl;
    }
    ...
    protected void onPostExecute(Void result) {
    	...
    	mLoginTaskControl.doInTaskDone();
    }
